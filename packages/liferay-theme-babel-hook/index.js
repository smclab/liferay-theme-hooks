...
var BABEL_PLUGIN_TRANSFORM_ES2015_MODULES_AMD_PATH = require.resolve('babel-plugin-transform-es2015-modules-amd');

var BABEL_PLUGIN_NORMALIZE_REQUIRES_PATH = require.resolve('babel-plugin-normalize-requires');
var BABEL_PLUGIN_TRANSFORM_NODE_ENV_INLINE_PATH = require.resolve('babel-plugin-transform-node-env-inline');
var BABEL_PLUGIN_WRAP_MODULES_AMD_PATH = require.resolve('babel-plugin-wrap-modules-amd');
var BABEL_PLUGIN_NAME_AMD_MODULES_PATH = require.resolve('babel-plugin-name-amd-modules');
var BABEL_PLUGIN_NAMESPACE_AMD_DEFINE_PATH = require.resolve('babel-plugin-namespace-amd-define');
